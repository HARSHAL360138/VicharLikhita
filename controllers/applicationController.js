...
const getDropdownOptions = (req, res) => {
  res.status(200).json({
    courses: ["I/VIII (CBSE/State Board)", "IX/X (CBSE/State Board)", "XI/XII Science", "XI/XII Commerce", "XI/XII Arts","B.Com (All Semesters)","BBA/BCCA(All Semesters)","Ms-Office","Tally ERP","Abacus"],
